...
function SupermarketsPage() {
  ...
  async function load() {
    ...
    const localSupermarkets = JSON.parse(
      localStorage.getItem(`twimu_fallback_supermarkets`) || "[]",
    );
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">
          Manage and audit all branch activities in your network.
        </p>
      </div>
              ...
              <form onSubmit={add} className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    className="bg-white border-pink-200 text-slate-800 placeholder:text-slate-400 h-10 rounded-xl"
                ...
                <Button
                  type="submit"
                  className="w-full bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white border-0 shadow-md shadow-pink-500/20 h-10 rounded-xl"
                >
            ...
            <div className="divide-y divide-pink-50 max-h-[300px] overflow-y-auto">
              {allSupermarkets.map((r) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`p-2 rounded-xl transition-colors ${active ? "bg-pink-100 text-pink-600" : "bg-slate-100 text-slate-400"}`}
                    >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs text-slate-400 truncate flex items-center gap-1 mt-0.5">
                        <Navigation className="size-3" /> {r.location || "—"}
                      </div>
                    </div>
                  </button>
                );
          ...
          {selectedBranch ? (
            <>
                ...
                <CardContent className="p-6 sm:p-8">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-pink-600 text-xs font-bold uppercase tracking-wider mt-0.5">
              ...
              <Card className="bg-white/95 border-pink-100 shadow-md shadow-pink-100/30 text-slate-800 backdrop-blur-md">
                <CardHeader>
                  ...
                  <CardDescription className="text-slate-500">
                    14-day trend for {selectedBranch.name}
                  </CardDescription>
                </CardHeader>
            ...
            <div className="h-full flex items-center justify-center p-12 bg-white/50 border border-pink-100 rounded-2xl">
              <div className="text-center text-slate-400 max-w-sm">
                ...
                <p className="text-xs">
                  Create or select a supermarket branch on the left to see its branch-by-branch
                  operational metrics.
                </p>
              </div>
            </div>
